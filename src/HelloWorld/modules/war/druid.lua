function HelloWorld.war.druid:rotation_1()
    ...
    if (self.parent:get_player_buff_time('Облик кошки') > 0) then
        ...
        if ((self.parent:get_player_buff_time('Дикий рев') <= 8) and
            (((self.parent:get_ememy_debuff_time('Разорвать') + 2) >
                self.parent:get_player_buff_time('Дикий рев')) and
                ((self.parent:get_ememy_debuff_time('Разорвать') - 2) <
                    self.parent:get_player_buff_time('Дикий рев'))) and
            (self.parent:can_cast('Дикий рев')) and (self.parent:check_combo_points(1))) then
            Keystroke:show_spell(8)
            return
        end
        ...
        if ((self.parent:get_ememy_debuff_time('Разорвать', true) >= 8) and -- 6 в бис шмоте
            ...
            ((self.parent:get_power() <= 50) or (self.parent:get_player_buff_time(50334) > 0)) and
            (self.parent:check_combo_points(5))) then
